...
public class BulletWar{
    ...
    public BulletWar(GamePannel gp, KeyHandler keyH, int x, int y, String direction, WarShip warShip){
        this.gp=gp;
        this.keyH=keyH;
        this.x=x;
        toto = x;
    ...
    public void getBulletNuclearImage(){
        try {
            bullet = ImageIO.read(getClass().getResource("picture/missile_1.png"));
        }catch(IOException e){
            e.printStackTrace();
        }
    }
